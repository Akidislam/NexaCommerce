...
export default function AuthenticatedLayout({ children, header }) {
    ...
    const navigationItems = {
        ...
        vendor: [
            ...
            { name: 'Products', href: route('vendor.products.index'), icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4', active: route().current('vendor.products.*') },
            { name: 'Orders', href: route('vendor.orders.index'), icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01', active: route().current('vendor.orders.*') },
        ],
        customer: [
